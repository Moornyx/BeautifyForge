...
public class GuiScreenAdvancements extends GuiScreen implements ClientAdvancementManager.IListener
{
    ...
    private void renderInside(int p_191936_1_, int p_191936_2_, int p_191936_3_, int p_191936_4_)
    {
        ...
        {
        	drawGradientRect(p_191936_3_ + 9, p_191936_4_ + 18, p_191936_3_ + 9 + 234, p_191936_4_ + 18 + 113, -1072689136, -804253680);
            String s = I18n.format("advancements.empty");
            String s2 = I18n.format("advancements.empty2");
            int i = this.fontRenderer.getStringWidth(s);
            this.fontRenderer.drawString(s, p_191936_3_ + 9 + 117 - this.fontRenderer.getStringWidth(s) / 2, p_191936_4_ + 18 + 36 - this.fontRenderer.FONT_HEIGHT / 2, -1);
            this.fontRenderer.drawString(s2, p_191936_3_ + 9 + 117 - this.fontRenderer.getStringWidth(s2) / 2, p_191936_4_ + 18 + 56 - this.fontRenderer.FONT_HEIGHT / 2, -1);
//            this.fontRenderer.drawString(":(", p_191936_3_ + 9 + 117 - this.fontRenderer.getStringWidth(":(") / 2, p_191936_4_ + 18 + 113 - this.fontRenderer.FONT_HEIGHT, -1);
    ...
    public void renderWindow(int p_191934_1_, int p_191934_2_)
    {
        ...
        this.fontRenderer.drawString(I18n.format("gui.advancements"), p_191934_1_ + 96, p_191934_2_ + 6, 4210752);
    }
