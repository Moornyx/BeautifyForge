...
public class GuiLanguage extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRenderer, I18n.format("options.language"), this.width / 2, 12, 16777215);
//        this.drawCenteredString(this.fontRenderer, "(" + I18n.format("options.languageWarning") + ")", this.width / 2, this.height - 56, 8421504);
    ...
    class List extends GuiSlot
    {
        ...
        public List(Minecraft mcIn)
        {
            ...
            super(mcIn, GuiLanguage.this.width, GuiLanguage.this.height, 64, GuiLanguage.this.height - 65 + 4, 24);

            for (Language language : GuiLanguage.this.languageManager.getLanguages())
            {
            	if(!language.getLanguageCode().equals("ru_ru") && !language.getLanguageCode().equals("en_us")) {
                    if(language.getLanguageCode().equals("ru_ru") || language.getLanguageCode().equals("en_us")) {
        ...
        protected void drawSlot(int slotIndex, int xPos, int yPos, int heightIn, int mouseXIn, int mouseYIn, float partialTicks)
        {
            ...
            // Название языка
            GuiLanguage.this.drawCenteredString(GuiLanguage.this.fontRenderer, ((Language)this.languageMap.get(this.langCodeList.get(slotIndex))).toString(), this.width / 2, yPos + 5, 16777215);
