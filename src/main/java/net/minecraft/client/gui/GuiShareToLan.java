...
public class GuiShareToLan extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(101, this.width / 2 - 75, this.height / 6 + 24 * 2 - 10, 150, 20, I18n.format("lanServer.start")));
        this.buttonList.add(new GuiButton(102, this.width / 2 - 100, this.height / 6 + 24 * 6, 200, 20, I18n.format("gui.cancel")));
        this.gameModeButton = this.addButton(new GuiButton(104, this.width / 2 - 75,  this.height / 6 + 24 * 4 - 10, 150, 20, I18n.format("selectWorld.gameMode")));
        this.allowCheatsButton = this.addButton(new GuiButton(103, this.width / 2 - 75,  this.height / 6 + 24 * 5 - 10, 150, 20, I18n.format("selectWorld.allowCommands")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRenderer, I18n.format("lanServer.title"), this.width / 2, this.height / 6 + 36 - 10, 16777215);
        this.drawCenteredString(this.fontRenderer, I18n.format("lanServer.otherPlayers"), this.width / 2, this.height / 6 + 24 * 3 + 12 - 10, 16777215);
