...
//            this.buttonList.add(new GuiOptionButton(GameSettings.Options.REALMS_NOTIFICATIONS.getOrdinal(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), GameSettings.Options.REALMS_NOTIFICATIONS, this.settings.getKeyBinding(GameSettings.Options.REALMS_NOTIFICATIONS)));
        ...
        this.buttonList.add(new GuiButton(101, this.width / 2 - 155, this.height / 6 + 36 - 6, 150, 20, I18n.format("options.video")));
        this.buttonList.add(new GuiButton(106, this.width / 2 - 155, this.height / 6 + 60 - 6, 150, 20, I18n.format("options.sounds")));
        this.buttonList.add(new GuiButton(100, this.width / 2 - 155, this.height / 6 + 86 - 6, 150, 20, I18n.format("options.controls")));
        
        
        this.buttonList.add(new GuiButton(110, this.width / 2 + 5, this.height / 6 + 36 - 6, 150, 20, I18n.format("options.skinCustomisation")));
        this.buttonList.add(new GuiButton(103, this.width / 2 + 5, this.height / 6 + 60 - 6, 150, 20, I18n.format("options.chat.title")));
        this.buttonList.add(new GuiButton(102, this.width / 2 + 5, this.height / 6 + 86 - 6, 150, 20, I18n.format("options.language")));
        
        this.buttonList.add(new GuiButton(105, this.width / 2 - 75, this.height / 6 + 120 - 6, 150, 20, I18n.format("options.resourcepack")));
