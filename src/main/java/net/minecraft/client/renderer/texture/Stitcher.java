...
public class Stitcher
{
    ...
    public void doStitch()
    {
        ...
        net.minecraftforge.fml.common.ProgressManager.ProgressBar bar = net.minecraftforge.fml.common.ProgressManager.push("fml.texture.stitching", astitcher$holder.length);
