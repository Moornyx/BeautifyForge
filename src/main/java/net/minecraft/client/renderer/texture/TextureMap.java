...
public class TextureMap extends AbstractTexture implements ITickableTextureObject
{
    ...
    public void loadTextureAtlas(IResourceManager resourceManager)
    {
        ...
        net.minecraftforge.fml.common.ProgressManager.ProgressBar bar = net.minecraftforge.fml.common.ProgressManager.push("fml.texture.stitching", this.mapRegisteredSprites.size());
        loadedSprites.clear();
    ...
    private void finishLoading(Stitcher stitcher, net.minecraftforge.fml.common.ProgressManager.ProgressBar bar, int j, int k)
    {
        ...
        bar = net.minecraftforge.fml.common.ProgressManager.push("fml.texture.creation", 2);

        try
        {
            bar.step("fml.stitching");
            stitcher.doStitch();
        }
        ...
        bar.step("fml.allocating.gl.texture");
        ...
        net.minecraftforge.fml.common.ProgressManager.pop(bar);
        bar = net.minecraftforge.fml.common.ProgressManager.push("fml.texture.mipmap", stitcher.getStichSlots().size());
