...
public class TextureManager implements ITickable, IResourceManagerReloadListener
{
    ...
    {
        net.minecraftforge.fml.common.ProgressManager.ProgressBar bar = net.minecraftforge.fml.common.ProgressManager.push("fml.reloading.texture.manager", this.mapTextureObjects.keySet().size(), true);
