...
public class SimpleReloadableResourceManager implements IReloadableResourceManager
{
    ...
    {
        net.minecraftforge.fml.common.ProgressManager.ProgressBar resReload = net.minecraftforge.fml.common.ProgressManager.push(("fml.loading.resources"), resourcesPacksList.size()+1, true);
        this.clearResources();
        ...
        resReload.step("fml.reloading.listeners");
    ...
    {
        net.minecraftforge.fml.common.ProgressManager.ProgressBar resReload = net.minecraftforge.fml.common.ProgressManager.push("fml.loading.resources", 1);
    ...
    {
        net.minecraftforge.fml.common.ProgressManager.ProgressBar resReload = net.minecraftforge.fml.common.ProgressManager.push("fml.reloading", this.reloadListeners.size());
