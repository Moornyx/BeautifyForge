...
public class SoundHandler implements IResourceManagerReloadListener, ITickable
{
    ...
    public void onResourceManagerReload(IResourceManager resourceManager)
    {
        ...
        net.minecraftforge.fml.common.ProgressManager.ProgressBar resourcesBar = net.minecraftforge.fml.common.ProgressManager.push("fml.loading.sounds", resources.size(), false);
