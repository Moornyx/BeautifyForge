...
public class Loader
{
    ...
    private InjectedModContainer fml;
...
//    	net.minecraftforge.fml.client.FMLClientHandler.instance().addModAsResource(fml);
//    	net.minecraft.client.resources.Locale.instance().loadLocaleData;
//    	FMLClientHandler.getCurrentLanguage();
//    	I18n.setLocale(CURRENT_LOCALE);
//    	net.minecraft.client.resources.LanguageManager.loadLocaleDataFiles(resourceManager, list);
//    	client.getLanguageManager().getCurrentLanguage().getLanguageCode();
//    	net.minecraftforge.fml.common.FMLCommonHandler.).loadLanguage();
//    	cpw.mods.fml.common.registry.LanguageRegistry.instance().loadLanguagesFor();
        
        progressBar = ProgressManager.push("fml.loading", 7);
        progressBar.step("fml.loading.mods");
        initializeLoader();
        ...
        progressBar.step("fml.initializing.mods.phase1");
    ...
    public void preinitializeMods()
    {
        ...
        progressBar.step("fml.initializing.minecraft.engine");
    }
