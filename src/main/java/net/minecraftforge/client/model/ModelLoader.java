...
public final class ModelLoader extends ModelBakery
{
    ...
    public IRegistry<ModelResourceLocation, IBakedModel> setupModelRegistry()
    {
        ...
        ProgressBar bakeBar = ProgressManager.push("fml.modelloader.baking", models.keySet().size());
    ...
    protected void loadBlocks()
    {
        ...
        ProgressBar blockBar = ProgressManager.push("fml.modelloader.blocks", blocks.size());
    ...
    protected void loadItemModels()
    {
        ...
        ProgressBar itemBar = ProgressManager.push("fml.modelloader.items", items.size());
        for(Item item : items)
        {
